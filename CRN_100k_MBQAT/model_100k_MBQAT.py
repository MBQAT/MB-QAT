        ...
        for epoch in range(start_epoch, args.max_epoch):
            ...
            for i, (mixtures, labels, noises) in enumerate(tr_batch_dataloader.dataloader):
                ...
                if (i + 1) % args.eval_steps == 0:
                    ...
                    checkpoint = CheckpointMB(epoch + 1, avg_train_loss, best_loss, network.module.state_dict(),
                                              optimizer.state_dict())
                    model_name = args.model_path + '{}-{}-val.ckpt'.format(epoch + 1, i + 3)
                    ...
                    network.train()
                    cnt = 0.
            shutil.copy('train_100k_MBQAT.log', args.log_path + 'train_100k_MBQAT.log')
            scheduler.step()
